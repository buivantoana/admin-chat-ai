...
const Loading = ({ message = "Loading...", size = "md" }) => {
   ...
   return (
      <div className="d-flex flex-column align-items-center justify-content-center" style={{ height: "100vh", position: "fixed", top: 0, left: 0, width: "100%", background: "rgba(255,255,255,0.6)", zIndex: 10000 }}>
