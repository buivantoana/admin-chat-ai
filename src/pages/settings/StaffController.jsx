...
const StaffController = () => {
   const [staff, setStaff] = useState(localStorage.getItem("managed_users") ? JSON.parse(localStorage.getItem("managed_users")) : [])
   ...
   return (
      <div>
         ...
         <CreateUserModal show={showModal} handleClose={() => setShowModal(false)} formData={formData} setFormData={setFormData} handleCreate={handleCreateUser} />
      </div>
...
const CreateUserModal = ({ show, handleClose, handleCreate, formData, setFormData }) => {
            ...
            <Form>
               ...
               <Form.Group className="mb-3">
                  ...
                  <Select
                     options={botsList}
                     isMulti
                     value={botsList.filter((bot) => formData.bots.includes(bot.value))}
